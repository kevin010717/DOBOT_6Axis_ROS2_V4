...
static rosidl_typesupport_introspection_c__MessageMember dobot_msgs_v4__srv__PositiveKin_Response__rosidl_typesupport_introspection_c__PositiveKin_Response_message_member_array[1] = {
  {
    "res",  // name
